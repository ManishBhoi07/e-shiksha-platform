...
export default function VoiceNav() {
  ...
  // Ensure speech recognition stops when location changes or component unmounts
  useEffect(() => {
    stopHandle();
  ...
  return (
    <>
      <div className="">
        <button
          className="fixed z-50 bottom-5 right-5 text-white px-4 w-auto h-10 bg-[#1F2937] rounded-full hover:bg-[#4A77B5] active:shadow-lg mouse shadow transition ease-in  focus:outline-none animate-bounce duration-500" type="button"
